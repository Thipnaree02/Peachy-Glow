...
<html>
   ...
   <body>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="banner_taital_main">
                                 <h1 class="banner_taital">Peachy Glow</h1>
                                 <h5 class="tasty_text">Tasty Of DozeCafe</h5>
                                 <p class="banner_text">เพราะผิวสวยคือพื้นฐานของความมั่นใจ เราคัดสรรสกินแคร์คุณภาพระดับพรีเมียม เพื่อให้การดูแลผิวของคุณเป็นเรื่องง่าย ฟื้นฟู บำรุง และปกป้อง ให้ผิวแข็งแรง กระจ่างใส มั่นใจได้ทุกวันg </p>
                                 <div class="btn_main">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="banner_taital_main">
                                 <h1 class="banner_taital">Peachy Glow</h1>
                                 <h5 class="tasty_text">Tasty Of DozeCafe</h5>
                                 <p class="banner_text">เพราะผิวสวยคือพื้นฐานของความมั่นใจ เราคัดสรรสกินแคร์คุณภาพระดับพรีเมียม เพื่อให้การดูแลผิวของคุณเป็นเรื่องง่าย ฟื้นฟู บำรุง และปกป้อง ให้ผิวแข็งแรง กระจ่างใส มั่นใจได้ทุกวัน </p>
                                 <div class="btn_main">
                                    <div class="about_bt"><a href="#">About Us</a></div>
                                    <div class="callnow_bt active"><a href="#">Call Now</a></div>
                                 </div>
      ...
      <h1 class="coffee_taital">Peachy Glow</h1>
               ...
               <div class="row">
                  ...
                  <div class="map_main">
                     <div class="map-responsive">
                        <iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0s1a7phLN0iaD6-UE7m4qP-z21pH0eSc&amp;q=Eiffel+Tower+Paris+France" width="250" height="500" frameborder="0" style="border:0; width: 100%;" allowfullscreen=" width="250" height="500" frameborder="0" style="border:0; width: 100%;" allowfullscreen=""></iframe>
                     </div>
                  </div>
               </div>
            </div>
