<?php 
    include ("include/cus-up-script.php");
?>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header"><strong>Update Customer Information </strong></div>
                            <div class="card-body card-block">

                                <!-- <div class="col col-md-9"><label class=" form-control-label">Prefix</label></div> 
...
<!--======================================== php CODE FOR SHOW INFORMATION =========================-->
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="c_name" value="<?=$row['c_name']?>" id="company" placeholder="Enter full name..." class="form-control " ></div>
                                    ...
                                    <div class="form-group">
                                        <label style="margin-top:10px !important;" for="email" class=" form-control-label">Email</label>
                                        <input type="email" name="c_email" value="<?=$row['c_email']?>" id="vat" placeholder="Enter email..." class="form-control "></div>
                                        <div class="form-group">
                                            <label for="street" class=" form-control-label">Address</label>
                                            <textarea type="text" name="c_address" id="street" placeholder="Enter address(ex. Maha Sarakham, Thailand)" cols="10" rows="3" class="form-control col-6"><?=$row['c_address']?></textarea></div>
                                            <div class="row form-group">
                                                <div class="col-8">
                                                    <div class="form-group">
                                                        <label for="city" class=" form-control-label">Phone Number</label>
                                                        <input type="text" name="c_phone" value="<?=$row['c_phone']?>" id="city" placeholder="Enter Phone number" class="form-control "></div>
                                                    </div>
                                                    <div class="col-8">
                                                        <div class="form-group">
                                                            <label for="postal-code" class=" form-control-label">Date of Birth</label>
                                                            <input type="date" name="c_dob" value="<?=$row['c_dob']?>" id="postal-code" class="form-control "></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="c_regDate" class="form-control-label">Register Date</label>
                                                        <input type="date" name="c_regDate" value="<?= date('Y-m-d', strtotime($row['c_regDate'])); ?>" id="c_regDate" class="form-control">
                                                    </div>
