<?php 
    include ("include/insert-product.php");
?>
                                                    ...
                                                    <div class="card-body card-block">
                                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="text" id="text-input" name="p_name" placeholder="Enter product name" class="form-control" required></div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="email-input" class=" form-control-label">Product Price</label></div>
                                                                <div class="col-12 col-md-9"><input type="number" id="email-input" name="p_price" placeholder="Enter product price" class="form-control" required></div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="email-input" class=" form-control-label">Stock Amount</label></div>
                                                                <div class="col-12 col-md-9"><input type="number" id="email-input" name="p_stock" placeholder="Enter stock amount" class="form-control" required></div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="email-input" class=" form-control-label">Brand</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="email-input" name="p_brand" placeholder="Enter product brand" class="form-control" required></div>
                                                            </div>
                                                            
                                                            
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Product Details</label></div>
                                                                <div class="col-12 col-md-9"><textarea name="p_detail" id="textarea-input" rows="9" placeholder="Details..." class="form-control" required></textarea></div>
                                                            </div> 
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="email-input" class=" form-control-label">Expire Date</label></div>
                                                                <div class="col-12 col-md-9"><input type="date" id="email-input" name="p_expire" placeholder="Enter product brand" class="form-control"></div>
                                                            </div>
                                                            ...
                                                            <div class="row form-group">
                                                                    ...
                                                                    <?php
                                                                            ...
                                                                            $selectedCatId = ''; // Replace this with the actual value you want to be selected
                                                                ...
                                                                <div class="row form-group">
                                                                    ...
                                                                    <div class="col-12 col-md-9"><input type="file" id="file-input" name="p_ext" class="form-control-file"></div>
                                                                </div>
