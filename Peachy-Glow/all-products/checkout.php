                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="payment-icon">
                                        <ul style="display: flex; justify-content: space-between; padding: 0; list-style: none; align-items: center;">
                                            <li><img class="img-fluid" src="assets/images/payment-icon/1.png" alt="" style="width: 50px; height: 50px;"></li>
                                            <li><img class="img-fluid" src="assets/images/payment-icon/2.png" alt="" style="width: 50px; height: 50px;"></li>
                                            <li><img class="img-fluid" src="assets/images/payment-icon/3.png" alt="" style="width: 50px; height: 50px;"></li>
                                            <li><img class="img-fluid" src="assets/images/payment-icon/5.png" alt="" style="width: 50px; height: 50px;"></li>
                                            <li><img class="img-fluid" src="assets/images/payment-icon/7.png" alt="" style="width: 50px; height: 50px;"></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
